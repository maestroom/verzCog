    ...
    <div class="padding">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label><i class="material-icons">&#xe8c0;</i> {{ trans('backLang.appsSettings') }}</label>
                <hr>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label><i class="material-icons">&#xe8a4;</i> {{ trans('backLang.fieldsSettings') }}</label>
                <hr>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label><i class="material-icons">&#xe895;</i> {{ trans('backLang.frontSettings') }}</label>
                <hr>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="home_content1_section_id" id="home_content1_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->home_content1_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterSection->name)   !!}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="home_content2_section_id" id="home_content2_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->home_content2_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterSection->name)   !!}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="latest_news_section_id" id="latest_news_section_id" class="form-control c-select">
                    ...
                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                        <?php
                        ?>
                        <option value="{{ $WebmasterSection->id  }}" {{ ($WebmasterSection->id == $WebmasterSetting->latest_news_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterSection->name)   !!}</option>
                    @endforeach
                </select>
            </div>
