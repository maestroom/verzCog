...
{{Form::open(['route'=>['resourcesStore'],'id'=>'bootstrapTagsInputForm', 'method'=>'POST', 'files' => true])}}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="one_liner" id="one_liner">
    </div>

    <div class="form-group">
        <label for="contents">Resources Summary:</label>
        <textarea class="form-control" rows="5" id="resources_summary" name="resources_summary"></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="category_type" class="form-control" id="category_type">
            ...
            <option value="1">Nvpc Publications</option>
            <option value="2">Guides & Tools</option>
        </select>
    </div>
