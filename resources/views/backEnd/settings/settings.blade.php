                                    ...
                                    <div class="row"
                                        ...
                                        <div class="col-sm-11">
                                            <div id="cp3" class="input-group colorpicker-component">
                                                {!! Form::text('style_bg_color',$Setting->style_color2, array('placeholder' => '','class' => 'form-control','id'=>'style_bg_color', 'dir'=>trans('backLang.ltr'))) !!}
                                                    ...
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$Setting->style_footer_bg) }}"><img
                                                                    ...
                                                                    style="max-height: 200px;width: auto">
                                                            <br>
                                                            <small>{{ $Setting->style_footer_bg }}</small>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
