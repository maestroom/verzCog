        ...
        <div class="box">
            ...
            @if($CheckLayoutPermission[0]->create===1)
                ...
                <div class="row p-a pull-right" style="margin-top: -70px;">
                    <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("partnersCreate")}}">
                            &nbsp; New Partner
                        </a>
                    </div>
                </div>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($Partners as $partners)
                            <tr>
                                ...
                                <td>
                                    <small>{!! $partners->company_link   !!}</small>
                                </td>
                                 <td>
                                    <small>{!! $partners->created_at   !!}</small>
                                </td>
                                <td>
                                    <small>{!! $partners->updated_at   !!}</small>
                                </td>

                                <td class="text-center">
                                    @if($CheckLayoutPermission[0]->edit===1)
                                    <a class="btn btn-sm success"
                                       href="{{ route("partnersEdit",["id"=>$partners->id]) }}">
                                    ...
                                    <a class="btn btn-sm warning"
                                       href="{{ route("partnersDestroy",["id"=>$partners->id]) }}">
