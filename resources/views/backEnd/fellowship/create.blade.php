    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> Add New Fellowship</h3>
                <small>
                    <a href="{{ route('fellowship') }}">Fellowship</a> /
                    <a href="">Add New Fellowship</a>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
...
{{Form::open(['route'=>['fellowshipStore'],'id'=>'bootstrapTagsInputForm', 'method'=>'POST', 'files' => true])}}
...
<input type="button" id="add_more"  class="upload" value="Add More Files"/>
    ...
    <label>Fellowship Location:</label>
            <input type="text" class="form-control" name="fellowship_location" id="fellowship_location">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group date form_datetime registration_cutoff_date" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
            <input class="form-control" size="16" type="text" name="registration_cutoff_date" value="" readonly>
            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
        </div>
