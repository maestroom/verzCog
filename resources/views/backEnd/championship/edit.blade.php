    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> Edit Championship</h3>
                <small>
                    <a href="{{ route('championship') }}">Championship</a> /
                    <a href="">Edit Championship</a>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
{{Form::open(['route'=>['championshipUpdate',$Championship[0]->id],'id'=>'$Championship[0]->id', 'method'=>'POST', 'files' => true])}}
  <div class="form-group row">
    ...
    <div class="form-group col-md-12">
            <div class="form-group col-md-5">
                ...
                <div class="input-group date form_datetime start_datetime" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" name="start_date" value="{!! $Championship[0]->start_date !!}" readonly>
            ...
            <div class="form-group col-md-5">
                ...
                <div class="input-group date form_datetime end_datetime" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                    <input class="form-control" size="16" name="end_date" type="text" value="{!! $Championship[0]->end_date !!}" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" id="dtp_input1" value="" /><br/>
    ...
    <input type="text" class="form-control" value="{!! $Championship[0]->title !!}" name="title" id="title">
  </div>

    <div class="form-group">
      <label for="contents">Contents:</label>
      <textarea class="form-control" rows="5" id="contents" name="contents">{!! $Championship[0]->contents !!}</textarea>
    </div>


<div class="form-group row">
<label for="contents">Championship Images (Additional Images are added):</label>
...
<input type="button" id="add_more"  class="upload" value="Add More Files"/>
    ...
    <label>Championship Location:</label>
            <input type="text" class="form-control" value="{!! $Championship[0]->location !!}" name="championship_location" id="championship_location">
    </div>
