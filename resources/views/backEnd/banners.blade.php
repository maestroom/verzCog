        ...
        <div class="box">
            ...
            @if($CheckLayoutPermission[0]->create===1)
                ...
                <div class="row p-a pull-right" style="margin-top: -70px;">
                    <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("bannersCreate")}}">
                            &nbsp; New Banner
                        </a>
                    </div>
                </div>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($Banners as $banners)
                            <tr>
                                ...
                                <td>
                                    <small>{!! $banners->banner_link   !!}</small>
                                </td>
                                 <td>
                                    <small>{!! $banners->created_at   !!}</small>
                                </td>
                                <td>
                                    <small>{!! $banners->updated_at   !!}</small>
                                </td>

                                <td class="text-center">
                                    @if($CheckLayoutPermission[0]->edit===1)
                                    <a class="btn btn-sm success"
                                       href="{{ route("bannersEdit",["id"=>$banners->id]) }}">
                                    ...
                                    <a class="btn btn-sm warning"
                                       href="{{ route("bannersDestroy",["id"=>$banners->id]) }}">
